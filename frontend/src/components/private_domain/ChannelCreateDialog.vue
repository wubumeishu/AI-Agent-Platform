<template>
  <form @submit.prevent="handleSubmit">
    ...
    <div class="form-group">
      ...
      <select v-model="formData.channel_type" class="form-select" required>
    ...
    <div class="form-group">
      <label class="form-label">平台 ID *</label>
      <input
...
function handleSubmit() {
  if (!formData.name || !formData.channel_type || !formData.platform_id) {
    return
  }
