<template>
  <form @submit.prevent="handleSubmit">
    ...
    <div class="form-group">
      ...
      <select v-model="formData.channel_id" class="form-select">
...
watch(() => props.plan, (newPlan) => {
  if (newPlan) {
    formData.name = newPlan.name || ''
    formData.channel_id = newPlan.channel_id || ''
    formData.status = newPlan.status || 'draft'
    formData.description = newPlan.description || ''
    formData.schedule_type = newPlan.schedule_type || 'fixed'
    formData.target_segment_id = newPlan.target_segment_id || ''
  }
}, { immediate: true })
...
function handleSubmit() {
  ...
  if (formData.channel_id) data.channel_id = formData.channel_id
